...
tel == "994200398" && email == "samuelnaslima.98@gmail.com" && cid == "BARRAS" && ano == "1998"){
    alert("Olá Samuel, Você está cadastrado em dois sistemas a senha de acesso ao site concursos públicos é: concursos24 e a senha de acesso as notas acadêmicas é: boletim10");
}
